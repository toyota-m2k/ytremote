...
class MicVideoPlayer @JvmOverloads constructor(
    ...
    private var mClipping = Range.empty
...
//                    endReachedListener.invoke(this@MicVideoPlayer)
    ...
    val clipChangedListener = Funcies2<MicVideoPlayer, Range?, Unit>()
...
//        get() = mClipping
    ...
    fun setSource(uri: Uri, clipping:Range, autoPlay: Boolean) {
     ...
     */
    private fun createClippingSource(orgSource:MediaSource, clipping:Range) : MediaSource {
